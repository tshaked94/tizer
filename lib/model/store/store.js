const { findStore, editStore: editStoreInDB, deleteStore: deleteStoreInDB,
    findStoreRlReviews } = require('../../../database/dbController');
...
const getStore = async (id) => {
    if (id) {
        ...
        reviews.forEach(function (part, index) {
            this[index].updatedAt = moment(new Date(this[index].updatedAt)).format('DD/MM/YYYY HH:MM');
            this[index].createdAt = moment(new Date(this[index].createdAt)).format('DD/MM/YYYY HH:MM');
        }, reviews);
